...
class myComplex:
    ...
    def output(self,s):
        with open("C:\\Users\\manor\\Desktop\\P346 codes\\Assignment-1\\Output(Q5).txt",'a') as file:
            file.write(s)
            file.close()
        return

#Function to create a output file
with open("C:\\Users\\manor\\Desktop\\P346 codes\\Assignment-1\\Output(Q5).txt",'w') as file:
    file.write("OUTPUT : \n")
    file.close()
