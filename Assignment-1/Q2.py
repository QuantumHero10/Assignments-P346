...
def output(s):
    with open("C:\\Users\\manor\\Desktop\\P346 codes\\Assignment-1\\Output(Q2).txt",'a') as file:
        file.write(s)
        file.write('\n')
        file.close()
    return
...
with open("C:\\Users\\manor\\Desktop\\P346 codes\\Assignment-1\\Output(Q2).txt",'w') as file:
    file.write("OUTPUT : \n")
    file.close()
cd=1.5
cr=0.5
