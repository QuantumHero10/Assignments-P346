...
def output(s):
    with open("C:\\Users\\manor\\Desktop\\P346 codes\\Assignment-2\\Output(Q3).txt",'a') as file:
        file.write(s)
        file.close()
    return

#Function to create a output file
with open("C:\\Users\\manor\\Desktop\\P346 codes\\Assignment-2\\Output(Q3).txt",'w') as file:
    file.write("OUTPUT : \n")
    file.close()
